...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<Category, CategoryResponseDTO>()
            .ForCtorParam("CategoryId", opt => opt.MapFrom(src => src.Id.Id));
        ...
        CreateMap<Order, OrderResponseDTO>()
            .ForCtorParam("OrderId", opt => opt.MapFrom(src => src.Id.Id))
        ...
        CreateMap<OrderItems, OrderItemResponseDTO>()
            .ForCtorParam("OrderItemsId", opt => opt.MapFrom(src => src.Id.Id))
        ...
        CreateMap<Payment, PaymentResponseDTO>()
            .ForCtorParam("PaymentId", opt => opt.MapFrom(src => src.Id.Id))
            .ForCtorParam("OrderId", opt => opt.MapFrom(src => src.OrderId.Id));

        // ProductPriceHistory Mappings
        CreateMap<ProductPriceHistory, ProductPriceHistoryResponseDTO>()
            .ForCtorParam("ProductPriceHistoryId", opt => opt.MapFrom(src => src.Id.Id))
            .ForCtorParam("ProductId", opt => opt.MapFrom(src => src.ProductId.Id));

        // InventoryMovement Mappings
        CreateMap<InventoryMovement, InventoryMovementResponseDTO>()
            .ForCtorParam("InventoryMovementId", opt => opt.MapFrom(src => src.Id.Id))
            .ForCtorParam("ProductId", opt => opt.MapFrom(src => src.ProductId.Id));
        ...
        CreateMap<Inventory, InventoryResponseDTO>()
            ...
            .ForCtorParam("ProductId", opt => opt.MapFrom(src => src.ProductId.Id))
            .ForCtorParam("AvailableQuantity", opt => opt.MapFrom(src => src.StockQuantity - src.ReservedQuantity));
